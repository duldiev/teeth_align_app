...
class DoctorPersonalDataView extends StatefulWidget {
  const DoctorPersonalDataView({super.key});

  @override
  State<DoctorPersonalDataView> createState() => _DoctorPersonalDataViewState();
}

class _DoctorPersonalDataViewState extends State<DoctorPersonalDataView> {
  @override
  void initState() {
    super.initState();
