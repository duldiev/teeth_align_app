...
// 1. Данныйларды уже боевой салу, тестовыйларды алып тастау
// 2. Корректировать работу чата
// 3. Добавить ссылку на конференсию в созданий поста
// + Ментор, докторлар рольдерде настройки элайнера шыгып тур
// 5. Ментор рольде докторлар шыкпай тур(бэктыда карайм)
// 6. Иконка салып кою в приложение
